...
import { getSupportedPlatforms } from '../../utils/platformDetect';
...
const PlatformBadges = () => {
  ...
  return (
    <div className="platform-badges animate-fade-in delay-3">
        ...
        <div className="platform-badges-list">
          {platforms.map((platform) => (
            <div
              ...
              title={`Supported: ${platform.name}`}
            >
              <span className="platform-badge-icon">
                {platformIcons[platform.id]}
              </span>
              <span className="platform-badge-name">{platform.name}</span>
            </div>
          ))}
        </div>
      </div>
